                        ...
                        <tr key={user.id}>
                            ...
                            <td className=" flex p-5 justify-center items-center">
                                <div className=" flex justify-between w-52 p-2">
                                    <Link to={`/edit/${user.id}`} className=" bg-green-500 rounded-md py-2
                                     px-6 hover:bg-green-400">Edit</Link>
                                     <button className=" bg-red-500 rounded-md py-2 px-6 hover:bg-red-400" onClick={() => deleteUser(user.id)}>Del</button>
                                </div>
                            </td>
                        </tr>
                    ))}
